...
import { ArrowLeft, Eye, EyeOff, Building2, Loader } from 'lucide-react';
      ...
      <div className="w-full max-w-md bg-gray-900 border border-gray-800 rounded-xl p-8">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Create your hiring account</p>
          </div>
        </div>
        ...
        <form onSubmit={formik.handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className={`bg-gray-800 border rounded-lg px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none transition ${formik.touched.companyName && formik.errors.companyName
          ...
          {/* Email */}
          <div className="flex flex-col gap-1">
            <label className="text-sm text-gray-300 font-medium">Work Email</label>
            <input
              type="email"
              name="email"
